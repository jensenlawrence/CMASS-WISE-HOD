...
def get_model_params(params_file):
    ...
    print(model_params['halo_params']['cosmo_model'])
    print(type(model_params['halo_params']['cosmo_model']))


    if model_params['halo_params']['cosmo_model'] == 'Planck15':
        model_params['halo_params']['cosmo_model'] = Planck15
    elif type(model_params['halo_params']['cosmo_model']) == dict:
        params =  model_params['halo_params']['cosmo_model']
        params['m_nu'] = np.array([params['m_nu'], 0, 0]) * u.eV
        model_params['halo_params']['cosmo_model'] = Planck15
        
        model_params['halo_params']['cosmo_params'] = params
        print(type(model_params['halo_params']['cosmo_params']))
...
def get_model_dicts(params_file):
    ...
    corr_flag = model_params['corr_flag']

    return cmass_model, wise_model, corr_flag
