...
class Transfer(cosmo.Cosmology):
    ...
    def k(self):
        "Wavenumbers, [h/Mpc]"
        # print('in self.k')
        # print(np.shape(np.arange(self.lnk_min, self.lnk_max, self.dlnk)))
    ...
    def power(self):
        ...
        # print('in self.power')
        power = self.growth_factor ** 2 * self._power0
    ...
    def nonlinear_delta_k(self):
        ...
        """
        # print('in nonlinear delta_k')
        # print('takahashi',self.takahashi)
